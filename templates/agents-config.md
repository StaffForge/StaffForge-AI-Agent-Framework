...
**Author**: Project Configuration System  
**Status**: Active
...
- No agent may override rules defined in this document without explicit human authorization
...
- Communicate results per team Synchronization schedule
